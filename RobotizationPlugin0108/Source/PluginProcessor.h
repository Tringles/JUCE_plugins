...
/**
*/
class RobotizationPlugin0108AudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    RobotizationPlugin0108AudioProcessor();
    ~RobotizationPlugin0108AudioProcessor() override;
    ...
    {
    public:
        RobotizationWhisperization (RobotizationPlugin0108AudioProcessor& p) : parent (p)
        {
        }
    ...
    private:
        ...
        RobotizationPlugin0108AudioProcessor& parent;
    };
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RobotizationPlugin0108AudioProcessor)
};
