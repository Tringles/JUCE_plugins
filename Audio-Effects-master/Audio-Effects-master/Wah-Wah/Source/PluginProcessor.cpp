...
WahWahAudioProcessor::WahWahAudioProcessor():
...
#endif
    parameters (*this)
    , paramMode (parameters, "Mode", modeItemsUI, modeAutomatic)
    ...
    , paramGain (parameters, "Gain", "dB", -80.0f, 20.0f, 0.0f,
    ...
    , paramLFOfrequency (parameters, "LFO Frequency", "Hz", 0.0f, 5.0f, 1.0f)
    , paramMixLFOandEnvelope (parameters, "LFO/Env", "", 0.0f, 1.0f, 0.5f)
    , paramEnvelopeAttack (parameters, "Env. Attack", "ms", 0.1f, 100.0f, 5.0f, [](float value){ return value * 0.001f; })
    , paramEnvelopeRelease (parameters, "Env. Release", "ms", 10.0f, 1000.0f, 50.0f, [](float value){ return value * 0.001f; })
{
